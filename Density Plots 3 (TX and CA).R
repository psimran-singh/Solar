...
p1 <- ggplot(solar_data5og, aes(`% Solar Panel Installed`)) +
  geom_density() + 
...
p2 <- ggplot(solar_data5og, aes(`Median KW Potential`)) +
  geom_density() + 
...
p3 <- ggplot(solar_data5og, aes(`% w/ Health Insurance`)) +
  geom_density() + 
...
p4 <- ggplot(solar_data5og, aes(`Property Crime Rate`)) +
  geom_density() + 
...
p5 <- ggplot(solar_data5og, aes(`% w/ Bachelor's Degree`)) +
  geom_density() + 
...
p6 <- ggplot(solar_data5og, aes(`Population Density`)) +
  geom_density() + 
...
p7 <- ggplot(solar_data5og, aes(`Net Migration Rate`)) +
  geom_density() + 
...
p8 <- ggplot(solar_data5og, aes(`% Population Age 45-64`)) +
  geom_density() + 
...
p9 <- ggplot(solar_data5og, aes(`% Female`)) +
  geom_density() + 
  ggtitle("% Female") +
  xlab("% Female") +
  ylab("Density") +
...
p10 <- ggplot(solar_data5og, aes(`% White`)) +
  geom_density() + 
  ggtitle("% White") +
  xlab("% White") +
  ylab("Density") +
...
p11 <- ggplot(solar_data5og, aes(`Income per Capita`)) +
  geom_density() + 
...
p12 <- ggplot(solar_data5og, aes(`Entrepeneurship Score`)) +
  geom_density() + 
...
p13 <- ggplot(solar_data5og, aes(`Belief in Science Score`)) +
  geom_density() + 
...
p14 <- ggplot(solar_data5og, aes(`Risk Taking Score`)) +
  geom_density() + 
...
p15 <- ggplot(solar_data5og, aes(`Religiosity Score`)) +
  geom_density() + 
...
p16 <- ggplot(solar_data5og, aes(`Income Mobility Score`)) +
  geom_density() + 
...
plotlist2 <- list(p1, p17, p18)
ggarrange(plotlist=plotlist2,nrow=1,ncol=3)
